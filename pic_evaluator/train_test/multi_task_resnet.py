...
class MultiOutputResNet(nn.Module):
    ...
    def __init__(self, block, layers):
        ...
        self.avgpool = nn.AdaptiveAvgPool2d(1)           #通道数不变，尺寸将为1
        self.fc1 = nn.Linear(512 * block.expansion, 2)
        self.fc2 = nn.Linear(512 * block.expansion, 2)
        self.fc3 = nn.Linear(512 * block.expansion, 2)
        self.fc4 = nn.Linear(512 * block.expansion, 2)
        self.fc5 = nn.Linear(512 * block.expansion, 2)
...
#base on resnet50
def MultiTaskResnet():
    model = MultiOutputResNet(Bottleneck, [3, 4, 6, 3])
    return model
